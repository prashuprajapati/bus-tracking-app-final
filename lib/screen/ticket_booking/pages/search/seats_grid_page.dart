...
//   SeatsGridPage({super.key, this.flight});
...
class SeatsGridPage extends StatefulWidget {
  ...
  const SeatsGridPage({Key? key, required this.flight}) : super(key: key);
                      ...
                      Container(
                        ...
                        child: ClipRRect(
                          ...
                          child: GridView.count(
                            ...
                            mainAxisSpacing: 0,
                            crossAxisSpacing: 0,
                            children: List.generate(widget.flight! .seats!.length, (index) {
                              return InkWell(
                                onTap: () {
                                  setState(() {
                                    seatSelected = index;
                                ...
                                child: Container(
                                  ...
                                  child: Image.asset(
                                    seatSelected == index
                                        ? 'assets/images/seats/seat_3.jpg'
                                        : widget.flight!.seats![index].available
                                            ? 'assets/images/seats/seat_1.jpg'
                                            : 'assets/images/seats/seat_2.jpg',
                                    width: 28,
                                  ),
